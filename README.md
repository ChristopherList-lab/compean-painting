...
- `site/` — the one-page website (plain HTML/CSS/JS, no build step)
...
1. Replace the temporary AI-generated photos in `site/assets/` (hero.jpg, junior.jpg,
...
3. Drag the `site/` folder into [Netlify Drop](https://app.netlify.com/drop) —
...
To use Concept B or C instead: replace `site/assets/logo-horizontal.svg` and
`site/assets/logo-stacked-white.svg` with that concept's files from `brand/logos/`.
